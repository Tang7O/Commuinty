...
public class MessageController implements CommunityConstant {
    ...
    public String getLetterList(Model model, Page page) {
        ...
        //会话列表
        List<Message> conversationList = messageService.findCoversations(
    ...
    public String getNoticeDatail(@PathVariable("topic") String topic, Page page, Model model) {
        User user = hostHolder.getUser();
        ...
        if (null != noticeList) {
            for (Message notice : noticeList) {
                ...
                map.put("user", userService.findUserById((Integer)date.get("userId")));
                map.put("entityType", date.get("entityType"));
                map.put("entityId", date.get("entityId"));
                map.put("postId", date.get("postId"));
                // 作者
